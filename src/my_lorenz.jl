...
function run_lorenz(x0=0.0, y0=0.0, z0=0.0;
    ...
    if do_plot
        ...
        subplot(311); ax1 = gca(); grid(true); ylabel("X")
        ...
        subplot(312, sharex=ax1); grid(true); ylabel("Y")
        plot(t[1:l], yN[1:l], color="red", linewidth=1.5)
        plot(t[1:l], y[1:l], color="green", linestyle="--", linewidth=1.5)
        subplot(313, sharex=ax1); grid(true); ylabel("Z"); xlabel("time")
        ...
        subplot(311); ax1 = gca(); grid(true); ylabel("X error")
        plot(t[1:l], xN[1:l] .- x[1:l], color="red", linewidth=1.5)
        subplot(312, sharex=ax1); grid(true); ylabel("Y error")
        plot(t[1:l], yN[1:l] .- y[1:l], color="red", linewidth=1.5)
        subplot(313, sharex=ax1); grid(true); ylabel("Z error"); xlabel("time")
